...
export async function loadOperationsDashboard(projects: OperationsProject[], now = new Date()) {
  ...
  const [settingsResult, publicityResult, rolesResult, assignmentsResult, googleSettingsResult, auditionsResult, calendarResult, linksResult] = await Promise.all([
  ...
  const warnings = [settingsResult, publicityResult, rolesResult, assignmentsResult, googleSettingsResult, auditionsResult, calendarResult, linksResult]
