...
export const standardAuditionFields: AuditionFieldInput[] = [
  ...
  { section_key: "experience", field_key: "role_interests", label: "Roles That Interest You", field_type: "role_selector", required: false, options: [], help_text: "Select any roles you would like us to consider.", placeholder: "", sensitivity: "standard", profile_field: "", export_group: "roles", sort_order: 100 },
  ...
  { section_key: "experience", field_key: "production_interests", label: "Production-Team Interests If Not Cast", field_type: "multiple_choice", required: false, options: ["Not interested", "Producing", "Stage Management", "Dramaturgy", "Lighting", "Sound", "Carpentry", "Costumes", "Props", "Stage Hand / Run Crew", "House Management", "Marketing / PR"], help_text: "Select all that apply.", placeholder: "", sensitivity: "standard", profile_field: "", export_group: "production_interests", sort_order: 140 },
...
export const optionalMusicFields: AuditionFieldInput[] = [
  { section_key: "music", field_key: "vocal_range", label: "Vocal Range", field_type: "single_choice", required: false, options: ["Soprano", "Mezzo-Soprano", "Alto", "Tenor", "Baritone", "Bass", "Unknown", "Other"], help_text: "", placeholder: "", sensitivity: "standard", profile_field: "", export_group: "music", sort_order: 300 },
  ...
  { section_key: "music", field_key: "instruments", label: "Instruments and Proficiency", field_type: "long_text", required: false, options: [], help_text: "", placeholder: "", sensitivity: "standard", profile_field: "", export_group: "music", sort_order: 320 },
  { section_key: "music", field_key: "dance_movement", label: "Dance or Movement Experience", field_type: "long_text", required: false, options: [], help_text: "", placeholder: "", sensitivity: "standard", profile_field: "", export_group: "movement", sort_order: 330 }
];
