...
export const standardAuditionFields: AuditionFieldInput[] = [
  ...
  { section_key: "schedule", field_key: "callback_availability", label: "Callback Availability", field_type: "single_choice", required: true, options: ["Yes", "No", "Other"], help_text: "Published callback dates from this project’s Audition & Callback Blocks appear here automatically.", placeholder: "", sensitivity: "standard", profile_field: "", export_group: "callbacks", sort_order: 200 },
