...
export const emailTemplateVariables:Record<EmailTemplateTag,string[]>={
  profile_access:["person_name","profile_access_url","expires_in"],profile_update_reminder:["person_name","project_title","profile_access_url","expires_in"],publicity_reminder:["person_name","project_title","outstanding_items","bio_due_date","headshot_due_date","profile_access_url","expires_in"],submission_reminder:["person_name","project_title","outstanding_items","profile_access_url"],role_group_welcome:["person_name","project_title","role_name","role_group","google_group_email","propared_rolegroup_link","profile_access_url"],role_acceptance:["person_name","project_title","role_name","agreement_type","role_acceptance_url","expires_in"],profile_verification_code:["person_name","verification_code","expires_in"],cast_announcement:["person_name","project_title","role_name","role_group"],crew_announcement:["person_name","project_title","role_name","role_group"],role_confirmation:["person_name","project_title","role_name","role_group"],audition_reminder:["person_name","project_title"],audition_callback:["person_name","project_title"],recognition:["person_name","project_title","recognition_title","recognition_issuer","recognition_date","recognition_description"],custom:["person_name","full_name","preferred_name","project_title","role_name","role_group"]
};

export async function activeEmailTemplate(tag:EmailTemplateTag,projectId:string|null=null){
